            ...
            <div class="row gx-lg-5 align-items-start">
                <div class="col-12 col-sm-12 col-md-12 col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="ls-about-desc">
                        <h4>Welcom to Pangong Sarai</h4>
                        <p><strong>Walk around the lake and delight yourself in the blocked off part nature.</strong></p>
                        <p>Just like the firefly looks for the undisturbed nature for its environment, Pangong Sarai turns into the home to the migrants in the disconnection. Pangong Sarai is found simply outside the Pangong Tso. The lake is a surprising marvel in the mountains. The camps give a brave ordeal to the explorers. Climbing around the mountains, trekking and investigating the untouched land are the essentials of being here. We serve you with the flavors of Ladakh in the Pangong style to enrich you in the extreme.</p>
                        <div class="mt-4 pt-3">
            ...
            <div class="row gx-lg-5">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                    <div class="room-desc-box">
                        <!--                        <h5>Mud House</h5>-->
                        <hr>
                        <p>The Shyok River meets the Siachan River to shape a substantial valley that isolates the Ladakh and Karakoram Ranges. In this valley lies a land of utmost luxury and magnificent which connects you to the nature’s paradise. Nubra Sarai features best in room amenities in the valley. The comfortable lounge offers stunning panoramic views and breath taking sunrises over the Himalayan range midst of the sand dunes. You can relax in your warm accommodation, admiring the views and treating yourself. We provide you with a daunting experience including lavish services and cleanliness.</p>
                    </div>
                </div>
            </div>
