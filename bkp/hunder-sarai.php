            ...
            <div class="row gx-lg-5 align-items-start">
                <div class="col-12 col-sm-12 col-md-12 col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="ls-about-desc">
                        <h4>Welcome to Hunder Sarai</h4>
                        <p><strong>Barren cold snow mountains near to the sand dunes and the camel ride area.</strong></p>
                        <p>Treating the visitors with the Ladakhi hospitality is core of Hunder Sarai. In the Nubra Valley, within the Hundar village lays the Sarai camps. The camps are surrounded by the barren cold snow mountains near to the sand dunes and the camel ride area. In between the gardens outside slows a stream of crystal clear water. The land of Sarai offers food in the Ladakhi and Western kind of cooking. You can walk around to the nearby attractions or bicycle a few miles to breathe in the faultless air.</p>
                        <div class="mt-4 pt-3">
            ...
            <div class="row gx-lg-5">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                    <div class="room-desc-box">
                        <!--                        <h5>Mud House</h5>-->
                        <hr>
                        <p>Ladakh is a land of adventure and highlights. The elevating land of Sarai in the Hunder village gives you a nomad adventure escape. Unwind and splash up the staggering views in the solace of the Mountain view camps. You can set out an experience on one of the numerous trails encompassing our resort. Running, meditating, trekking and cycling are the essentials of Hunder Sarai. The accommodation is warm and comfortable for you to sink down in the remarkable corner of the world. Sustenance is the way to appreciate, and we plan crisp and delightful nourishments for our guests.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-0">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="ls-location-desc">
                    <h4>Location</h4>
                    <ul>
                        <li>Located: Hunder, Nubra Valley</li>
                        <li>Walking distance from Shyok River bank</li>
                        <li>Walking distance from Nubra Valley</li>
                        <li>Diskit Gompa 7.8 km away</li>
                        <li>Sand Dunes Leisure Park 13 mints walk away</li>
