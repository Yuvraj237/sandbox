            ...
            <div class="row gx-lg-5 align-items-start">
                <div class="col-12 col-sm-12 col-md-12 col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="ls-about-desc">
                        <h4>Welcome to Tara Mountain Sarai</h4>
                        <p><strong>A Melange of adrenaline adventure and mindful meditation.</strong></p>
                        <p>Nestled amidst the untamed wilderness of the Zanskar valley, where the Tsarap and Kargyak rivers converge in a mesmerizing dance, lies Tara Mountain Sarai, Purne. A beacon of opulence in this unspoiled paradise, it stands as the sole luxury boutique hotel in the region, inviting travelers to indulge in an unforgettable experience.</p>
                        <p>Tara Mountain Sarai offers a myriad of experiences, tailor-made to capture the essence of the Zanskar valley. Embark on guided expeditions through rugged trails, where breathtaking vistas unfold at every turn. Immerse yourself in the rich cultural tapestry of the region, exploring ancient monasteries and engaging with the welcoming local communities.</p>
                        <div class="mt-4 pt-3">
            ...
            <div class="row gx-lg-5">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                    <div class="room-desc-box">
                        <!--                        <h5>Mud House</h5>-->
                        <hr>
                        <p>Perched on the edge of this pristine landscape, Tara Mountain Sarai exudes an air of tranquility and grandeur. Its architecture seamlessly blends with the surrounding natural beauty, paying homage to the Zanskari heritage while offering all the modern comforts one could desire. As the sun’s golden rays illuminate the valley, the hotel stands as a testament to the harmonious coexistence of nature and human creativity.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-0">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="ls-location-desc">
                    <h4>Location</h4>
                    <ul>
                      <li>Located: Purne, Zanskar Valley</li>
                        <li>Walking distance from Zanskar Valley</li>
                        <li>Walking distance from Tsarap River</li>
                        <li>Gonbo Rongjon a few minutes drive away</li>
...
-->
                    <div class="knowmore">
                        <p class="m-0"><a class="btn gold d-inline-block" href="https://www.google.co.in/maps/place/Hunder+Sarai/@34.5857013,77.4303559,13z/data=!4m9!3m8!1s0x38fc4dd207c2955f:0xe9573a0c9bb518cf!5m2!4m1!1i2!8m2!3d34.584224!4d77.4675441!16s%2Fg%2F11sk6wnp6l?entry=ttu" target="_blank"><span>Get direction</span></a></p>
                    </div>
